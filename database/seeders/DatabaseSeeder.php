<?php
    ...
    class DatabaseSeeder extends Seeder
    {
        ...
        public function run()
        {
            ...
            // users
            User::create(['name' => 'mahmoud', 'email' => 'mahmoud@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
            User::create(['name' => 'nizar', 'email' => 'nizar@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
            ...
            User::create(['name' => 'zozo', 'email' => 'zozo@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
            ...
            DB::table('conversation_user')->insert(['conversation_id' => 2, 'user_id' => 3, 'created_at' => now(), 'updated_at' => now(),]);
